...
| <a name="module_ec2_instance_freyja"></a> [ec2\_instance\_freyja](#module\_ec2\_instance\_freyja) | terraform-aws-modules/ec2-instance/aws | 5.7.0 |
...
| Name | Description |
|------|-------------|
| <a name="output_ami_details"></a> [ami\_details](#output\_ami\_details) | n/a |
